...
class TestRuleBasedPipelineInit:
    ...
    def test_init_htrg_without_torch_raises(self):
        ...
        from locisimiles.pipeline.rule_based import TORCH_AVAILABLE, RuleBasedPipeline
    ...
    def test_init_similarity_without_spacy_raises(self):
        ...
        from locisimiles.pipeline.rule_based import SPACY_AVAILABLE, RuleBasedPipeline
...
class TestRuleBasedDocumentConversion:
    ...
    def test_matches_to_candidates(self, sample_document, sample_source_document):
        ...
        matches = [[1, "src1", "source text", "seg1", "target text", "shared; words"]]

        result = pipeline.generator._matches_to_candidates(
            matches, sample_source_document, sample_document
        )
